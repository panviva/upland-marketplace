...
| `sangt-daily-mandatory-skills` | Daily-driver session skills (start-my-day, compact multi-model plan-for-goal with Gemini 3.8 / GPT-5.6 / GPT-6 Astra / Kimi 3, project-setup, session-start, session-handoff, session-calibrate) — a full cross-session workflow |
